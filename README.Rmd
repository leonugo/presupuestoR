...
[Español](#readme-en-español) Este paquete proporciona una colección de funciones para el análisis presupuestario utilizando datos abiertos de [Transparencia Presupuestaria](https://www.transparenciapresupuestaria.gob.mx/).

[English](#readme-in-english) This package provides a collection of functions for budget analysis using open data from [Transparency platform in Mexico](https://www.transparenciapresupuestaria.gob.mx/).

## Readme en español {#spanish}

### Instalación

La versión en desarrollo puede ser instalada de [GitHub](https://github.com/) con:
...
- `entidad_to_abr2()`: Abrevia el nombre de una entidad mexicana. Está basada en [LorenzoLeon/mexicoR](https://github.com/LorenzoLeon/mexicoR).
...
- `gen_clas_eco()`: Genera la columna de clasificación económica en los datos presupuestarios. La clasificación económica fue realizada por [Katia Guzman](https://github.com/guzmart).
...
You can install the development version of presupuestoR from [GitHub](https://github.com/) with:
...
-   `entidad_to_abr2()`: Abbreviates the name of a Mexican entity. It is based on [LorenzoLeon/mexicoR](https://github.com/LorenzoLeon/mexicoR).
...
-   `gen_clas_eco()`: Generates the economic classification column in the budget data. The economic classification was made by [Katia Guzman](https://github.com/guzmart).
